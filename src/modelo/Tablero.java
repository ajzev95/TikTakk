...
public class Tablero extends JPanel {
    ...
    public void cambiarEstilos(TipoImagen jugadorAct) {
        if (jugadorAct == TipoImagen.CIRCULO) {
            FormTikTac.imgJugadorEquis.setRuta(Ruta.JUGADORAUXILLAR);
            FormTikTac.imgJugadorEquis.repaint();
            FormTikTac.nombreJugadorEquis.setForeground(new Color(240, 240, 240, 100));

            FormTikTac.imgJugadorCirculo.setRuta(Ruta.JUGADORCIRCULO);
            FormTikTac.imgJugadorCirculo.repaint();
            FormTikTac.nombreJugadorCirculo.setForeground(new Color(255, 200, 255));
        } else if (jugadorAct == TipoImagen.EQUIS) {
            FormTikTac.imgJugadorCirculo.setRuta(Ruta.JUGADORAUXILLAR);
            FormTikTac.imgJugadorCirculo.repaint();
            FormTikTac.nombreJugadorCirculo.setForeground(new Color(240, 240, 240, 100));

            FormTikTac.imgJugadorEquis.setRuta(Ruta.JUGADOREQUIS);
            FormTikTac.imgJugadorEquis.repaint();
            FormTikTac.nombreJugadorEquis.setForeground(new Color(180, 232, 255));
        }
    }
    ...
    public void reiniciarTablero(TipoImagen ganador) {
        ...
        if (ganador == TipoImagen.EQUIS) {
            int puntajeNuevo = Integer.parseInt(FormTikTac.puntajeEquis.getText()) + 1;
            FormTikTac.puntajeEquis.setText(String.valueOf(puntajeNuevo));
        } else if (ganador == TipoImagen.CIRCULO) {
            int puntajeNuevo = Integer.parseInt(FormTikTac.puntajeCirculo.getText()) + 1;
            FormTikTac.puntajeCirculo.setText(String.valueOf(puntajeNuevo));
        }
